---
title: Passing thoughts on Agentic Engineering
date: 2026-07-24
...
- Feedback loops are tighter, 
    ...
    - This means everybody is being asked to review more code while still doing their work. Even if you trust the AI to code the team still needs the systems concepts and behavior in their head to move the project forward and perform support.
...
- Use the tools daily to know what does and doesn’t work. They are changing with each release, keep up.